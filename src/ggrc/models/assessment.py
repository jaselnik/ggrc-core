...
class Assessment(Assignable,
  ...
  def validate_change_state(self, old_value):
    ...
    if new_value == old_value:
      return None
    if old_value in self.NOT_DONE_STATES and \
