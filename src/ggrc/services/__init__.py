...
def contributed_services():
  ...
  return [
      ...
      service('contracts', models.Contract, external.ExternalResource),
      service('evidence', models.Evidence),
      service('policies', models.Policy, external.ExternalResource),
      ...
      service('objectives', models.Objective, external.ExternalResource),
      ...
      service('requirements', models.Requirement, external.ExternalResource),
      service('risks', models.Risk, external.ExternalResource),
      service('threats', models.Threat, external.ExternalResource),
      service('systems',
              models.System,
