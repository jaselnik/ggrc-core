...
def contributed_services():
  ...
  return [
      ...
      service('external_directives', models.ExternalDirective,
              common.ReadOnlyResource),
      service('contracts', models.Contract),
      service('evidence', models.Evidence),
      service('policies', models.Policy),
      service('regulations', models.Regulation, external.ExternalResource),
      service('standards', models.Standard, external.ExternalResource),
